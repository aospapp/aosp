...
public class AutoLauncherStrategy implements IAutoLauncherStrategy {
    ...
    private static final Map<String, BySelector> FACET_MAP =
            Stream.of(
                            new Object[][] {
                                ...
                                {
                                    "Notification",
                                    By.res(SYSTEM_UI_PACKAGE, "notifications").clickable(true)
                                },
                                {
                                    "Google Assistant",
                                    By.res(SYSTEM_UI_PACKAGE, "assist").clickable(true)
                                },
                            })
                    .collect(
                            Collectors.toMap(
    ...
    public void openMediaFacet(String appName) {
        ...
        List<UiObject2> buttons = mDevice.wait(Until.findObjects(APP_SWITCH), APP_LAUNCH_TIMEOUT);

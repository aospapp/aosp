...
public class AppIsNotRespondingWatcher2 implements UiWatcher {
    private static final String LOG_TAG = AppIsNotRespondingWatcher2.class.getSimpleName();
    ...
    public AppIsNotRespondingWatcher2(Instrumentation instrumentation) {

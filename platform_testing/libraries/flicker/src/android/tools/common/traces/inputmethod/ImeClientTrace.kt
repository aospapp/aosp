 ...
 * entry
 *
 * Each entry is parsed into a list of [ImeClientEntry] objects.
 *
...
data class ImeClientTrace(override val entries: Array<ImeClientEntry>) : ITrace<ImeClientEntry> {
     ...
     */
    override fun slice(startTimestamp: Timestamp, endTimestamp: Timestamp): ImeClientTrace {
        return ImeClientTrace(
            this.entries

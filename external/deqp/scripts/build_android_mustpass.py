...
MAIN_VULKAN_PKG				= Package(module = VULKAN_MODULE, configurations = [
		...
		Configuration(name					= "master-2022-03-01",
					  ...
					  listOfGroupsToSplit	= ["dEQP-VK"]),
		Configuration(name					= "master-2023-03-01",
					  filters				= MAIN_VULKAN_FILTERS + [exclude("vk-master-2019-03-01.txt"), exclude("vk-master-2020-03-01.txt"), exclude("vk-master-2021-03-01.txt"), exclude("vk-master-2022-03-01.txt"),],
					  runtime				= "10m",
					  listOfGroupsToSplit	= ["dEQP-VK"]),
		Configuration(name					= "incremental-deqp",

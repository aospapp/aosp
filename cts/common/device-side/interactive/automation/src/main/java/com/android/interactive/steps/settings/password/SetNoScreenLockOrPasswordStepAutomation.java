...
@AutomationFor("com.android.interactive.steps.settings.password.SetNoScreenLockOrPasswordStep")
public final class SetNoScreenLockOrPasswordStepAutomation implements Automation<Nothing> {
    @Override

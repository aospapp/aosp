...
/** Automation for DidGTSInteractiveMediaPlayerAppearStep. **/
@AutomationFor("com.google.android.interactive.steps.enterprise.systemui"
        + ".DidGTSInteractiveMediaPlayerAppearStep")
public class DidGTSInteractiveMediaPlayerAppearStepAutomation implements Automation<Boolean> {


    @Override
    public Boolean automate() throws Exception {
        return MediaControlsHelper.findMediaControls() != null;
    }

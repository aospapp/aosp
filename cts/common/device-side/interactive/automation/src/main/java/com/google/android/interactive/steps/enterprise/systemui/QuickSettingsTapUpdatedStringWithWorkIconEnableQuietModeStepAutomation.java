...
/** Automation for QuickSettingsTapUpdatedStringWithWorkIconEnableQuietModeStep */
@AutomationFor("com.google.android.interactive.steps.enterprise.systemui"
        + ".QuickSettingsTapUpdatedStringWithWorkIconEnableQuietModeStep")
public final class QuickSettingsTapUpdatedStringWithWorkIconEnableQuietModeStepAutomation implements
        Automation<Boolean> {
    @Override

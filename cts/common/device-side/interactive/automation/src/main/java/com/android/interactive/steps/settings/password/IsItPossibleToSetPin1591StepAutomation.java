...
@AutomationFor("com.android.interactive.steps.settings.password.IsItPossibleToSetPin1591Step")
public final class IsItPossibleToSetPin1591StepAutomation implements Automation<Boolean> {
    @Override

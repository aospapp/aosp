...
@AutomationFor("com.google.android.interactive.steps.enterprise.launcher"
        + ".PressEmergencyCallButtonStep")
public final class PressEmergencyCallButtonStepAutomation implements Automation<Nothing> {

    @Override
    public Nothing automate() throws Exception {
        TestApis.ui().device().findObject(new UiSelector().className(Button.class).text(
                "Emergency").className(Button.class)).click();
        return NOTHING;
    }
}

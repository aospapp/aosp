...
public final class AccountsRemoveWorkProfileStep extends ActAndWaitStep {

    public AccountsRemoveWorkProfileStep() {
        super("Use the 'Remove Work Profile' button in the work accounts section"
                        + " to remove the work profile",
                                () ->

...
/**
 * Starting from anywhere, launch the work settings app.
 *
 * <p>This will be the only settings app if there is no separate work settings app.
 */
public final class LaunchWorkSettingsStep extends ActAndConfirmStep {
    public LaunchWorkSettingsStep() {
        super("Launch Settings. If this device has a separate app for work Settings, "
                + "launch the work version.");
    }
}

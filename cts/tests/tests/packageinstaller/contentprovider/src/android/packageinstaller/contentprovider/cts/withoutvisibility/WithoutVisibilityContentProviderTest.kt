...
package android.packageinstaller.contentprovider.cts.withoutvisibility

import android.packageinstaller.contentprovider.cts.ContentProviderAppVisibilityTestsBase
import org.junit.Test

class WithoutVisibilityContentProviderTest : ContentProviderAppVisibilityTestsBase() {

    @Test
    fun whenUnprotectedContentProviderAccessed_TestCantFindIt() {
    ...
    @Test
    fun whenExportedContentProviderAccessed_withInvalidPermissionPattern_TestCantFindIt() {
        runTest(TYPE_EXPORTED_CONTENT_PROVIDER, permissionPattern = "")
        assertErrorDialogNotVisible()
        assertResultFirstUser()
    }

    @Test
    fun whenExportedContentProviderAccessed_withValidPermissionPattern_TestCantFindIt() {
    ...
    fun whenUnexportedContentProviderIsAccessed_WithInvalidUriPermissionPattern_TestCantFindIt() {
        runTest(TYPE_UNEXPORTED_CONTENT_PROVIDER, permissionPattern = "/foo/baz")
        assertErrorDialogNotVisible()
        assertResultFirstUser()
    }

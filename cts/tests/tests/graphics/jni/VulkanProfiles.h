...
#define VP_ANDROID_BASELINE_2021_MIN_API_VERSION VK_MAKE_VERSION(1, 0, 68)
    ...
    defined(VK_KHR_surface) && \
    defined(VK_KHR_swapchain)
#define VP_ANDROID_baseline_cpu_only_2021 1
#define VP_ANDROID_BASELINE_CPU_ONLY_2021_NAME "VP_ANDROID_baseline_cpu_only_2021"
#define VP_ANDROID_BASELINE_CPU_ONLY_2021_SPEC_VERSION 1
#define VP_ANDROID_BASELINE_CPU_ONLY_2021_MIN_API_VERSION VK_MAKE_VERSION(1, 0, 68)
#endif

...
public class CreateCredentialResponseTest {

    @Test
    public void testConstructor_nullData() {
        assertThrows(NullPointerException.class, () ->
                new CreateCredentialResponse(null));
    }
    ...
    public void testConstructor() {
        ...
        final CreateCredentialResponse response =
    ...
    public void testWriteToParcel() {
        ...
        final CreateCredentialResponse resp1 = new CreateCredentialResponse(data);
        final CreateCredentialResponse resp2 = cloneParcelable(resp1);

        assertEquals(resp2.getData(), resp1.getData());
    }
}

...
public class CreateEntryTest {
    ...
    public void testConstructor_nullSlice() {
        assertThrows(NullPointerException.class, () -> new CreateEntry(null));
    }
    ...
    public void testWriteToParcel() {
        final CreateEntry entry1 = new CreateEntry(mSlice);

        final CreateEntry entry2 = TestUtils.cloneParcelable(entry1);

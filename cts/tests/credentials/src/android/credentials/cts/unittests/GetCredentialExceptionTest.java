...
public class GetCredentialExceptionTest {

    @Test
    public void testConstructor_nullType() {
        assertThrows(IllegalArgumentException.class, () ->
                new GetCredentialException(null, null, null));
    }

    @Test
    public void testConstructor_type() {
        final String type = GetCredentialException.TYPE_UNKNOWN;

        final GetCredentialException exc =
                new GetCredentialException(type);
    ...
    public void testConstructor_type_message() {
        ...
        final GetCredentialException exc =
                new GetCredentialException(type, message);
    ...
    public void testConstructor_type_cause() {
        ...
        final GetCredentialException exc =
                new GetCredentialException(type, cause);
    ...
    public void testConstructor_type_message_cause() {
        ...
        final GetCredentialException exc =
                new GetCredentialException(type, message, cause);

...
#ifndef TEXT_STREAM_GRAPH_RTCP_H
#define TEXT_STREAM_GRAPH_RTCP_H

#include <ImsMediaDefine.h>
#include <TextStreamGraph.h>

class TextStreamGraphRtcp : public TextStreamGraph
{
public:
    TextStreamGraphRtcp(BaseSessionCallback* callback, int localFd = 0);

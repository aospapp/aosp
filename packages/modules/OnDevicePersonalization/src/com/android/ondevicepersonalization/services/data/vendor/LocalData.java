...
/**
 * LocalData object for the LocalData table
 */
@DataClass(
        genBuilder = true,
...
public class LocalData {
    ...
    //
    // To regenerate run:
    // $ codegen $ANDROID_BUILD_TOP/packages/modules/OnDevicePersonalization/src/com/android/ondevicepersonalization/services/data/vendor/LocalData.java
    //
    ...
    public boolean equals(@android.annotation.Nullable Object o) {
        ...
        // boolean fieldNameEquals(LocalData other) { ... }
        // boolean fieldNameEquals(FieldType otherValue) { ... }

        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        @SuppressWarnings("unchecked")
        LocalData that = (LocalData) o;
    ...
    public static class Builder {
        ...
        public @NonNull LocalData build() {
            checkNotUsed();
            mBuilderFieldsSet |= 0x4; // Mark builder used

            LocalData o = new LocalData(
                    mKey,
                    mData);
            return o;
        }
    ...
    @DataClass.Generated(
            ...
            sourceFile = "packages/modules/OnDevicePersonalization/src/com/android/ondevicepersonalization/services/data/vendor/LocalData.java",
            inputSignatures = "private final @android.annotation.NonNull java.lang.String mKey\nprivate final @android.annotation.NonNull byte[] mData\nclass LocalData extends java.lang.Object implements []\n@com.android.ondevicepersonalization.internal.util.DataClass(genBuilder=true, genEqualsHashCode=true)")
    @Deprecated

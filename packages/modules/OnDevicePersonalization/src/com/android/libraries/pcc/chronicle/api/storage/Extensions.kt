...
package com.android.libraries.pcc.chronicle.api.storage
...
fun Instant.toProtoTimestamp(): Timestamp = Timestamp.newBuilder().setSeconds(this.getEpochSecond()).setNanos(this.getNano()).build()

...
/**
 * An implementation of the {@link DeviceFinalizeClient} which always return a successful response.
 */
@Keep
public final class DeviceFinalizeClientDebug extends DeviceFinalizeClient {
    ...
    public ReportDeviceProgramCompleteResponse reportDeviceProgramComplete() {
        // Client has nothing to receive from the response. An empty response means the request
        // was successful.

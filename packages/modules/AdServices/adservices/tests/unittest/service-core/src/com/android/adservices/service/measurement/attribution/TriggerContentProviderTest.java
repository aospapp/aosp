...
public class TriggerContentProviderTest {
    private static final Uri TRIGGER_URI_T_PLUS =
            Uri.parse("content://com.android.adservices.provider.trigger");
    private static final Uri TRIGGER_URI_S_MINUS =
            Uri.parse("content://com.android.ext.adservices.provider.trigger");

    @Mock private Context mContext;
    @Mock private ContentResolver mContentResolver;
    private TriggerContentProvider mSpyContentProvider;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        mSpyContentProvider = Mockito.spy(new TriggerContentProvider());
    }
